...
public:
    ...
    void setupUi(QWidget *FormEditorMachine)
    {
        if (FormEditorMachine->objectName().isEmpty())
            FormEditorMachine->setObjectName(QString::fromUtf8("FormEditorMachine"));
        ...
        tool_frame->setStyleSheet(QString::fromUtf8("color:white;background:#01547a;"));
        ...
        tool_pointer->setObjectName(QString::fromUtf8("tool_pointer"));
        ...
        tool_pointer->setStyleSheet(QString::fromUtf8(""));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_arrow.gif"), QSize(), QIcon::Normal, QIcon::Off);
        tool_pointer->setIcon(icon);
        tool_pointer->setIconSize(QSize(24, 24));
        tool_pointer->setCheckable(true);
        tool_pointer->setChecked(false);
        ...
        tool_machine_right->setObjectName(QString::fromUtf8("tool_machine_right"));
        ...
        tool_machine_right->setStyleSheet(QString::fromUtf8(""));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_r_small.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_left_word->setObjectName(QString::fromUtf8("tool_machine_left_word"));
        ...
        tool_machine_left_word->setStyleSheet(QString::fromUtf8(""));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_l_big.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_translate->setObjectName(QString::fromUtf8("tool_translate"));
        sizePolicy1.setHeightForWidth(tool_translate->sizePolicy().hasHeightForWidth());
        tool_translate->setSizePolicy(sizePolicy1);
        tool_translate->setStyleSheet(QString::fromUtf8(""));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_hand.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_copy->setObjectName(QString::fromUtf8("tool_machine_copy"));
        sizePolicy1.setHeightForWidth(tool_machine_copy->sizePolicy().hasHeightForWidth());
        tool_machine_copy->setSizePolicy(sizePolicy1);
        tool_machine_copy->setStyleSheet(QString::fromUtf8(""));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_k.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_lambda->setObjectName(QString::fromUtf8("tool_machine_lambda"));
        ...
        tool_machine_lambda->setStyleSheet(QString::fromUtf8(""));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_lambda.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_finish->setObjectName(QString::fromUtf8("tool_machine_finish"));
        ...
        tool_machine_finish->setStyleSheet(QString::fromUtf8(""));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/images/toolbars/tools/icon_finish.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_trash->setObjectName(QString::fromUtf8("tool_trash"));
        sizePolicy1.setHeightForWidth(tool_trash->sizePolicy().hasHeightForWidth());
        tool_trash->setSizePolicy(sizePolicy1);
        tool_trash->setStyleSheet(QString::fromUtf8(""));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_delete.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_left->setObjectName(QString::fromUtf8("tool_machine_left"));
        sizePolicy1.setHeightForWidth(tool_machine_left->sizePolicy().hasHeightForWidth());
        tool_machine_left->setSizePolicy(sizePolicy1);
        tool_machine_left->setStyleSheet(QString::fromUtf8(""));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_l_small.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_right_word->setObjectName(QString::fromUtf8("tool_machine_right_word"));
        ...
        tool_machine_right_word->setStyleSheet(QString::fromUtf8(""));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_r_big.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_machine_start->setObjectName(QString::fromUtf8("tool_machine_start"));
        ...
        tool_machine_start->setStyleSheet(QString::fromUtf8(""));
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/images/toolbars/tools/icon_start.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        tool_link->setObjectName(QString::fromUtf8("tool_link"));
        sizePolicy1.setHeightForWidth(tool_link->sizePolicy().hasHeightForWidth());
        tool_link->setSizePolicy(sizePolicy1);
        tool_link->setStyleSheet(QString::fromUtf8(""));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_link.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        frame_navi->setObjectName(QString::fromUtf8("frame_navi"));
        ...
        tool_complex->setObjectName(QString::fromUtf8("tool_complex"));
        sizePolicy1.setHeightForWidth(tool_complex->sizePolicy().hasHeightForWidth());
        tool_complex->setSizePolicy(sizePolicy1);
        tool_complex->setStyleSheet(QString::fromUtf8(""));
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/Files/images/toolbars/tools/icon_complex.gif"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        _navi->setObjectName(QString::fromUtf8("_navi"));
        sizePolicy1.setHeightForWidth(_navi->sizePolicy().hasHeightForWidth());
        _navi->setSizePolicy(sizePolicy1);
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/Files/images/nav.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        properties_frame->setObjectName(QString::fromUtf8("properties_frame"));
        ...
        frame_5->setStyleSheet(QString::fromUtf8("color:white;background:#0095da"));
    ...
    {
        FormEditorMachine->setWindowTitle(QCoreApplication::translate("FormEditorMachine", "Form", nullptr));
        ...
        label_image->setText(QCoreApplication::translate("FormEditorMachine", "TextLabel", nullptr));
        label_title->setText(QCoreApplication::translate("FormEditorMachine", "TextLabel", nullptr));
    } // retranslateUi
