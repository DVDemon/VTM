...
public:
    ...
    void setupUi(QWidget *FormCompilerMachine)
    {
        if (FormCompilerMachine->objectName().isEmpty())
            FormCompilerMachine->setObjectName(QString::fromUtf8("FormCompilerMachine"));
        ...
        list_errors->setObjectName(QString::fromUtf8("list_errors"));
        ...
        toolBox->addItem(page_2, QString::fromUtf8("Messages"));
    ...
    {
        FormCompilerMachine->setWindowTitle(QCoreApplication::translate("FormCompilerMachine", "Form", nullptr));
        toolBox->setItemText(toolBox->indexOf(page_2), QCoreApplication::translate("FormCompilerMachine", "Messages", nullptr));
    } // retranslateUi
